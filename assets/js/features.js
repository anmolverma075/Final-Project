    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">Aroma's</span> <span class="clr-green">Cafe</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">Aroma's</span> <span class="clr-green md">Cafe</span></div>
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <p>Aroma's Cafe is private cafe in PSIT Kanpur. We serve fresh food made by the best chefs in the town. We have everday special meals and beverages.</p>
                        <ul class="py-1">
                            <li><i class="fab fa-facebook-f"></i><a href="https://www.facebook.com/psit.ac.in/" target="_blank"> Facebook</a></li>
                            <li><i class="fab fa-instagram"></i><a href="https://www.instagram.com/psitkanpur/?hl=en" target="_blank">Instagram</a></li>
                        </ul>
                    </article>
                    <!-- Navigation Links -->
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="our-vision.html">Our Vision</a></li>
                            <li><a href="https://github.com/anmolverma075" target="_blank">Git Repository</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-phone-alt"></i> <p>+91-7007-5222-05</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>admission@psitkanpur.ac.in</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>PSIT Kanpur , Bhauti , Uttar Pradesh</p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p>For Professional Courses, Visit: www.psit.ac.in</p></li>
                        </ul>
                    </article>
                </main>
                <!-- Anmol-Verma Info -->
                <main class="Anmol-Verma flex">
                    <div>© Copyright 2020 - 2021. All Rights Reserved</div>
                    <div class="">Designed & Developed with <i class="fas fa-heart clr-red"></i> By <a href="#">Anmol-Verma</a></div>
                </main>
            </section>
        `;
        })
        ...
        userFooter.forEach(element => {
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        <h1 class="sm">about</h1>
                        <p>Pranveer Singh Institute of Technology is affiliated to Abdul Kalam Technical University founded in 2004 and has a vision of establishing centers of scientific
